...
export default function ExploreScreen() {
  ...
  useEffect(() => { fetchCategories(); fetchCourses(); }, [selectedCategory, page]);

  const fetchCategories = async () => {
    try { const res = await categoryAPI.getAll(); setCategories(res.data); } catch (error) { console.error(error); }
  };
